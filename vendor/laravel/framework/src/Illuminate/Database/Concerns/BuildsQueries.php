...
use App\Http\Controllers\ReferralControllers\CommonController;
        ...
        if ($this->from == "add_report") {
            if (HomeController::isUserLoggedIn()) {
                ...
                if ($departmentAccess != null) {
                    $reportItem = $this->take(1)->get($columns)->first();

                    if ($reportItem) {
                        $orderDepartment = $reportItem->order_department;

                        if ($orderDepartment == $departmentAccess) {
                            return $reportItem;
                        }
                    }
