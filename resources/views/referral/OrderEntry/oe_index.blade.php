            ...
            <div id="ordersTableBack">
                <div id="headerHorizonatl" class="horizontal">
                    ...
                    <div class="vertical">
                        <div class="horizontal inputForm">
                            ...
                            <button type="button" class="btn btn-primary" onclick="goToRoute('referralpanel/orderentry/add_patient')">Add New Patient</button>
                        </div>
                ...
                <div class="horizontalAllCenter">
                    ...
                    <div class="horizontal inputForm">
                        ...
                        <div class="search-container">
                            <input id="referredByInput" class="inputField" placeholder="Referred By" value="{{ $user->name }}" @readonly(true)>
...
<script>
    ...
    var phoneUmrInputHandler = function(event) {
        ...
        if (phoneUmrInput.value.trim() == ""){
            ...
            if (phoneUmrInput.value.trim() != "") {
                ...
                fetch(webUrl + `referralpanel/orderentry/search_patient/${phoneUmrInput.value}`)
    ...
    $("#submitBillBtn").on('click', function() {
        ...
        form.method = "POST";
        form.action = webUrl + "referralpanel/orderentry/add_order_entry";
    ...
    var doctorInputHandler = function(event) {
        ...
        if (inputValue == "") {
            ...
            fetch(webUrl + `referralpanel/search_doctors/${inputValue}`)
                .then(response => response.json())
                .then(responseJson => {
                    var size = Object.keys(responseJson).length;
                    if (size == 0) {
    ...
    var orderInputHandler = function(event) {
        ...
        if (inputValue == "") {
            ...
            fetch(webUrl + `referralpanel/search_orders/${inputValue}`)
                .then(response => response.json())
                .then(responseJson => {
                    var size = Object.keys(responseJson).length;
                    if (size == 0) {
