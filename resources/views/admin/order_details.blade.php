...
<body>
    ...
    <div class="main_container">
        ...
        <div class="main">
            <div class="actions">
                <button type="button" class="btn btn-primary" onclick="goToRoute('add_order_details/{{ $reportDetails->report_id }}')"><i class='bx bx-plus-circle'></i> Add Order Details</button>
                <button type="button" class="btn btn-primary" onclick="goToRoute('order_maintenance')"><i class='bx bx-left-arrow-circle'></i> Back To Orders</button>
                <button type="button" class="btn btn-primary" onclick="goToRoute('order_template/{{ $reportDetails->report_id }}')">Templates</button>
                <button type="button" class="btn btn-primary" onclick="goToRoute('add_components_of_existing_order/{{ $reportDetails->report_id }}')">Add Components Of Existing Order</button>
                ...
                <table class="table" id="ordersTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td onclick="goToRoute('update_order_details/{{ $reportDetails->report_id }}/{{ $orderDetail->id }}')" style="cursor: pointer;">{{ $orderDetail->component_name }}</td>
