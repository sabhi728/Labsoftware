...
<body>
    ...
    <div class="main_container">
        ...
        <div class="main">
            <div class="actions">
                <button type="button" class="btn btn-primary" onclick="goToRoute('locations/add')"><i class='bx bx-plus-circle'></i> Add Location</button>
            </div>
            <div id="ordersTableBack">
                <table class="table" id="ordersTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="cursor: pointer;" onclick="goToRoute('locations/edit/{{ $location->id }}')">{{ $location->location_code }}</td>
                            ...
                            <td><i class='bx bx-trash' style="font-size: 30px;cursor: pointer;color: red;"
                                    onclick="if (confirm('Are you sure you want to delete this item?')) {
                                        goToRoute('locations/delete/{{ $location->id }}');
                                    }">
                                </i>
                            </td>
                        </tr>
