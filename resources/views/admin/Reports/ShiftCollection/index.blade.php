...
<body>
    ...
    <div class="main_container">
        ...
        <form action="{{ url('reports/shift_collection/report') }}" method="post" class="main">
            <div class="actions">
                <button type="submit" class="btn btn-primary" name="shiftCollectionDetailed">Shift Collection Detailed</button>
                <button type="submit" class="btn btn-primary" name="shiftCollection">Shift Collection</button>
                <button type="submit" class="btn btn-primary" name="summaryReport">Summary Report</button>
