...
<body>
    <div class="main_container" style="text-align: center; font-family: 'Microsoft JhengHei', Arial;">
        <div class="main">
            ...
            <br>
            <div id="BillRpt">
                <h4 style="text-align:center;margin-top:30px;">Collection Per Month Report Between the dates <b>{{ $fromDate }}</b> and <b>{{ $toDate }}</b></h4>
                <br>
                            ...
                            <div id="DataTable_wrapper" class="dataTables_wrapper no-footer">
                                ...
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="grid-header GridColumn sorting_disabled" style="width: 60px;" rowspan="1" colspan="1"><div class="grid-header-title"><span>Final Amount</span></div></th>
                                    ...
                                    @foreach($allData as $userKey => $userData)
                                        ...
                                        @foreach($userData as $transactionKey => $transactionData)
                                            @php
                                                ...
                                                $totalFinalAmount += $transactionData['final_amount'];
                                            ...
                                            @if($transactionKey == count($userData) - 1)
                                                <tr class="grid-row  odd grid-row-selected" role="row">
                                                    ...
                                                    <td class="grid-cell GridColumn" data-name="">{{ $totalFinalAmount }}</td>
