...
<body>
    <div class="main_container" style="text-align: center; font-family: 'Microsoft JhengHei', Arial;">
        <div class="main">
            ...
            <br>
            <div id="BillRpt">
                <h4 style="text-align:center;margin-top:30px;">Collection Per User Report Between the dates <b>{{ $fromDate }}</b> and <b>{{ $toDate }}</b></h4>
                <br>
                    ...
                    <div class="grid-mvc" data-lang="en" data-gridname="BillRpt" data-selectable="true" data-multiplefilters="false">
                        <div class="grid-wrap">
                            <div id="DataTable_wrapper" class="dataTables_wrapper no-footer">
                                ...
                                <thead>
                                    <tr role="row">
                                        <th class="grid-header Dateclmn sorting_disabled" style="width: 106px;" rowspan="1" colspan="1"><div class="grid-header-title"><span>User Name</span></div></th>
                                        <th class="grid-header GridColumn AlignCenter sorting_disabled" style="width: 62px;" rowspan="1" colspan="1"><div class="grid-header-title"><span>BillCount</span></div></th>
                                ...
                                <tbody>
                                    ...
                                    @foreach($allData as $userKey => $userData)
                                        ...
                                        @foreach($userData as $transactionKey => $transactionData)
                                            @php
                                                $totalBillCount += $transactionData['bill_count'];
                                                ...
                                                $totalBalanceAmount += $transactionData['balance_amount'];
                                            ...
                                            @if($transactionKey == count($userData) - 1)
                                                <tr class="grid-row  odd grid-row-selected" role="row">
                                                    <td class="grid-cell Dateclmn" data-name="">{{ $transactionData['username'] }}</td>
                                                    <td class="grid-cell GridColumn AlignCenter" data-name="">{{ $totalBillCount }}</td>
                                                    ...
                                                    <td class="grid-cell GridColumn" data-name="">{{ $totalBalanceAmount }}</td>
                                        ...
                                        @php
                                            ...
                                            $allBalanceAmount += $totalBalanceAmount;
                                    ...
                                    <tr class="grid-row  even" role="row">
                                        ...
                                        <td class="grid-cell GridColumn AlignCenter" data-name="">{{ $allBillCount }}</td>
                                        ...
                                        <td class="grid-cell GridColumn" data-name="">{{ $allBalanceAmount }}</td>
