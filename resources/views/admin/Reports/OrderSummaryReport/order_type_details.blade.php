        ...
        <div class="main">
            ...
            <div id="OrdRptDiv">
                <h4 style="text-align:center;margin-top:30px;">
                    Order Type Detailed Report Between the dates <b>{{ $fromDate }}</b> and <b>{{ $toDate }}</b>
                </h4>
                <br>
                            ...
                            <table class="table table-striped grid-table dataTable no-footer" id="DataTable" role="grid">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="grid-header GridColumn sorting_disabled" style="width: 84px;" rowspan="1" colspan="1"><div class="grid-header-title"><span>Amount</span></div></th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="grid-row  odd" role="row">
                                        ...
                                        <td class="grid-cell GridColumn" data-name="">{{ $order->total_bill }}</td>
