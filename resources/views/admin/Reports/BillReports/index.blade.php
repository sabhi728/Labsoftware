...
<body>
    ...
    <div class="main_container">
        ...
        <form action="{{ url('reports/bill_reports/report') }}" method="post" class="main">
            <div class="actions">
                <button type="submit" class="btn btn-primary" name="getReport">Get Report</button>
                <button type="submit" class="btn btn-primary" name="nonFinancial">Non Financial</button>
                <button type="submit" class="btn btn-primary" name="financial">Financial</button>
                <button type="submit" class="btn btn-primary" name="summary">Summary</button>
                <button type="submit" class="btn btn-primary" name="discountBillsReport">Discount Bills Report</button>
