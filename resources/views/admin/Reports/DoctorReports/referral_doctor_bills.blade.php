                ...
                <div style="border: groove; overflow-y: auto; padding-top: 10px; padding-bottom:2%; margin: 0 auto; width: 1150px; text-align: left; margin-top: 30px; background: white;">
                    <div class="grid-mvc" data-lang="en" data-gridname="RefRptGrid" data-selectable="true" data-multiplefilters="false">
                        <div class="grid-wrap">
                            ...
                            <thead>
                                <tr>
                                    <th class="grid-header GridColumn" style="width:10px;"><div class="grid-header-title"><span>Test Code</span></div></th>
                                    ...
                                    <th class="grid-header GridColumn" style="width:10px;"><div class="grid-header-title"><span>Order Amount</span></div></th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($allData as $order)
                                    <tr class="grid-row">
                                        <td class="grid-cell GridColumn" data-name="">{{ $order->order_test_code }}</td>
                                        ...
                                        <td class="grid-cell GridColumn" data-name="">{{ $order->order_amount }}</td>
                                    </tr>
                                @endforeach
                                <tr class="grid-row" style="border-top: groove;">
                                    <td class="grid-cell GridColumn" data-name="">Total Amount</td>
                                    <td class="grid-cell GridColumn" data-name="">Count={{ count($allData) }}</td>
                                    <td class="grid-cell GridColumn" data-name=""></td>
                                    <td class="grid-cell GridColumn" data-name=""></td>
                                    <td class="grid-cell GridColumn" data-name=""></td>
                                    <td class="grid-cell GridColumn" data-name=""></td>
                                    <td class="grid-cell GridColumn" data-name="">{{ $orderAmount }}</td>
                                </tr>
                            </tbody>
                            </table>
                        </div>
...
<script>
    ...
    function ExportToExcel(type, fn, dl) {
        ...
        return dl ?
            ...
            XLSX.writeFile(wb, fn || ('ReferralDoctorBills.' + (type || 'xlsx')));
    }
</script>
</html>
