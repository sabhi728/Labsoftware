                ...
                <div style="border: groove; overflow-y: auto; padding-top: 10px; padding-bottom:2%; margin: 0 auto; width: 950px; text-align: left; margin-top: 30px; background: white;">
                    <div class="grid-mvc" data-lang="en" data-gridname="RefRptGrid" data-selectable="true" data-multiplefilters="false">
                        <div class="grid-wrap">
                            ...
                            <thead>
                                <tr>
                                    <th class="grid-header GridColumn" style="width:10px;"><div class="grid-header-title"><span>Billed Date</span></div></th>
                                    <th class="grid-header GridColumn" style="width:10px;"><div class="grid-header-title"><span>Bill Number</span></div></th>
                                    <th class="grid-header GridColumn" style="width:25px;"><div class="grid-header-title"><span>Orders</span></div></th>
                                    ...
                                    <th class="grid-header GridColumn" style="width:10px;"><div class="grid-header-title"><span> Amount To Sales</span></div></th>
                                    <th class="grid-header GridColumn" style="width:10px;"><div class="grid-header-title"><span>Final Amount</span></div></th>
                                    <th class="grid-header GridColumn" style="width:10px;"><div class="grid-header-title"><span>Due Amount</span></div></th>
                            ...
                            <tbody>
                                @foreach ($orderDetails as $order)
                                    <tr class="grid-row">
                                        ...
                                        <td class="grid-cell GridColumn" data-name="">{{ $order->due_amount }}</td>
                                        <td class="grid-cell GridColumn" data-name="">{{ $order->amount_to_lab }}</td>
                                    </tr>
                                @endforeach
                                <tr class="grid-row" style="border-top: groove;">
                                    ...
                                    <td class="grid-cell GridColumn" data-name="">{{ $dueAmount }}</td>
...
<script>
    ...
    function ExportToExcel(type, fn, dl) {
        ...
        return dl ?
            ...
            XLSX.writeFile(wb, fn || ('GetReport.' + (type || 'xlsx')));
    }
</script>
</html>
