    ...
    <div class="main_container">
        ...
        <div class="main">
            <div class="actions">
                ...
                <button type="button" onclick="goToRoute('order_details/{{ $orderDetails->report_id }}')" class="btn btn-primary">Cancel</button>
            </div>
            @if(isset($orderInputData))
                <form id="formBack" action="{{ url('update_order_details', ['order_id' => $orderDetails->report_id, 'update_id' => $orderInputData->id]) }}" method="post">   
            @else
                <form id="formBack" action="{{ url('add_order_details', ['order_id' => $orderDetails->report_id]) }}" method="post">             
            @endif
                @csrf
                @if(isset($orderInputData))
